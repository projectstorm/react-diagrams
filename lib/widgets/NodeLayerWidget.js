...
export class NodeLayerWidget extends React.Component {
    ...
    render() {
        ...
        return (React.DOM.div({
            ...
            return (React.createElement(NodeWidget, { diagramEngine: this.props.diagramEngine, key: node.id, node: node }, this.props.diagramEngine.generateWidgetForNode(node)));
        })));
    }
}
